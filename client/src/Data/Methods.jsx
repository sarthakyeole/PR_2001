...
export const ObjectGroupBy = (object, group) => {
  ...
  if (!Array.isArray(object)) {
    console.error("ObjectGroupBy expected an array, but got:", object);
    return ans; // return empty object if input is not an array
  }
...
console.log("Transactions in getResult:", transactions);
